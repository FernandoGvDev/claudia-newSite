...
export default function FAQPage() {
  ...
  useEffect(() => {
    contentRefs.current.forEach((ref, index) => {
      if (!ref) return;
      ref.style.maxHeight = aberta === index ? ref.scrollHeight + "px" : "0px";
    });
  }, [aberta]);
  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      <Helmet>
        <title>FAQ - Steinntz Advogados | Atendimento Jurídico RS</title>
        <meta
          name="description"
          content="Perguntas frequentes sobre atendimento jurídico, consulta, pensão, divórcio, inventário e mais. Escritório Steinntz Advogados atendendo todo RS."
        />
      ...
      <h1 className="text-4xl font-bold text-[#57201c] mb-8 text-center">Perguntas Frequentes</h1>
